...
export MASK_TYPE="network" # network, input, both
export MASK_REG=0 # 0, 1

# Run your script (it should read both $SEED and $ENV_SEED from os.environ)
python -u main.py --config_path configs/config_a2c_extract_option.py