...
#SBATCH --output=logs/test_finetune_%A_%a.out    # %A = job ID, %a = array index
#SBATCH --error=logs/test_finetune_%A_%a.err
...
# ————— Run your script ——————
python main.py --config_path ~/scratch/neurips-2025-paper-neural-decomposition/config_test_finetune.py